...
NEWS_ITEMS = [
    {
        ...
        "content": (
            ...
            "Ünlü teknoloji lideri Sam Altman konuyla ilgili yaptığı açıklamada, 'Yapay zeka insanlığın en büyük ve dönüştürücü araçlarından biri olacak; ancak denetim ve güvenlik mekanizmalarını asla göz ardı edemeyiz' ifadelerini kullandığını söyledi. "
